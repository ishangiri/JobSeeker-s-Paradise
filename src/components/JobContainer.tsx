    ...
    <div className="flex flex-wrap gap-8 justify-center">
      {loading
        ...
        : allJobs.map((job) => {
            ...
            const time = new Date();
            const timeDifference = time.getTime() - updatedTime.getTime();
            
            const days = timeDifference/1000/60/60/24;

            const differenceinDays = Math.ceil(days);
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-gray-500 italic">{differenceinDays}d ago</p>
                  </div>
                </CardContent>
